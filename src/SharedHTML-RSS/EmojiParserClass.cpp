	...
	struct EmojiMaps
	{
...
#endif
		{
			...
			for (auto &e : m_emojis)
			{
				...
				m_regex_to_replacement.emplace_back(std::make_pair(re_emoji_1, replacement_1));
				m_regex_to_replacement.emplace_back(std::make_pair(re_emoji_2, replacement_2));
				m_regex_to_replacement.emplace_back(std::make_pair(re_emoji_3, replacement_3));
				m_regex_to_replacement.emplace_back(std::make_pair(re_emoji_4, replacement_4));
			}
		}
